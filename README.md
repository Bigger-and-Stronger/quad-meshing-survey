...
<table> 
<!-- ---------------------------------------------------------------------- -->
<tr><td><img title="image" src=".pic/Field-Smoothness-Controlled-Partition-for-Quadrangulation.png" width="600"><td>
...
<!-- ---------------------------------------------------------------------- -->
<tr><td><img title="image" src=".pic/Quadrilateral-mesh-generation-I-Metric-based-method.png" width="600"><td>

**Quadrilateral mesh generation I : Metric based method**

Wei Chen, Xiaopeng Zheng, Jingyao Ke, [Na Lei], Zhongxuan Luo, [Xianfeng Gu]

1 November 2019, CMAME

[[doi]](https://doi.org/10.1016/j.cma.2019.07.023)
...
<!-- ---------------------------------------------------------------------- -->
<tr><td><img title="image" src=".pic/Quadrilateral-and-hexahedral-mesh-generation-based-on-surface-foliation-theory.png" width="600"><td>

**Quadrilateral and hexahedral mesh generation based on surface foliation theory**

[Na Lei], Xiaopeng Zheng, Jian Jiang, Yu-Yao Lin, [Xianfeng Gu]

1 April 2017, CMAME

[[doi]](https://www.sciencedirect.com/science/article/pii/S0045782516312762)
<!-- ---------------------------------------------------------------------- -->
...
<!-- ---------------------------------------------------------------------- -->
<tr><td><img title="image" src=".pic/Automatic-domain-partitioning-for-quadrilateral-meshing-with-line-constraints.png" width="600"><td>

**Automatic domain partitioning for quadrilateral meshing with line constraints**

Nicolas Kowalski, Franck Ledoux, Pascal Frey

09 December 2014, Engineering with Computers

[[doi]](https://link.springer.com/article/10.1007/s00366-014-0387-5)
<!-- ---------------------------------------------------------------------- -->
...
<!-- ---------------------------------------------------------------------- -->
<tr><td><img title="image" src=".pic/Design-driven-quadrangulation-of-closed-3D-curves.png" width="600"><td>

**Design-driven quadrangulation of closed 3D curves**

Mikhail Bessmeltsev, Caoyu Wang, Alla Sheffer, Karan Singh

01 November 2012, TOG

[[doi]](https://dl.acm.org/doi/10.1145/2366145.2366197) [[pdf]](https://d1wqtxts1xzle7.cloudfront.net/73803543/Design-Driven_20Quadrangulation-libre.pdf?1635505062=&response-content-disposition=inline%3B+filename%3DDesign_driven_quadrangulation_of_closed.pdf&Expires=1747417590&Signature=PVQBBr3LtqYEgYpqzhScj9nVRXBSVwkmcbbh-x-~cwsUIwYFvFhrtgSfK59KSLHkvO78h9mhUShHXTMOSFyS-5LA6JMi4r9Robe9BNfe7vAnoQv1NL~FmmYjbPpTQRjyBbWnjNRNUSXSjCkXi8wYCCzi-3LzT2p3Ot7hll1JZtJcp0U10kQFHhnoTI9fW-lfFYmKCgZUmQJX9fN4-SX2sXSKNKUpcY9xY-prl4iWU-Uljs01nts~mlUrs8ijGPzDSIgilzbC0Ehqc1RHlb~lh~xSGhT8AmJ3zUogDG4ydaeAnzIDHy5XzlYqx47Wl-r6UXkV89Qv8zN6H7W~oDdIgA__&Key-Pair-Id=APKAJLOHF5GGSLRBV4ZA)
<!-- ---------------------------------------------------------------------- -->
...
[ZhongXuan Liang]: https://anderliang.github.io/
